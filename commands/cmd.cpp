...
// Staff Commands
    ...
    staffCommands.emplace("*combust", 100, dmKillSwitch, isDm, "Kill a player.");
    staffCommands.emplace("*slime", 100, dmKillSwitch, isDm, "Kill a player.");
    staffCommands.emplace("*gnat", 100, dmKillSwitch, isDm, "Kill a player.");
    staffCommands.emplace("*trip", 100, dmKillSwitch, isDm, "Kill a player.");
    staffCommands.emplace("*crush", 100, dmKillSwitch, isDm, "Kill a player.");
    staffCommands.emplace("*missile", 100, dmKillSwitch, isDm, "Kill a player.");
    staffCommands.emplace("*bomb", 100, dmKillSwitch, isDm, "Kill a player and everyone in room.");
    staffCommands.emplace("*nuke", 100, dmKillSwitch, isDm, "Kill a player and everyone in room.");
    staffCommands.emplace("*arma", 100, dmKillSwitch, isDm, "");
    staffCommands.emplace("*armageddon", 100, dmKillSwitch, isDm, "Kill all players.");
    staffCommands.emplace("*supernova", 100, dmKillSwitch, isDm, "Kill all players.");
    staffCommands.emplace("*igmoo", 100, dmKillSwitch, isDm, "Kill all players.");
    staffCommands.emplace("*rape", 100, dmKillSwitch, isDm, "Set a player to 1hp and 1mp.");
    staffCommands.emplace("*drain", 100, dmKillSwitch, isDm, "Set a player to 1hp and 1mp.");
