...
typedef enum {
    ...
    LOGIN_GET_NAME_ACCOUNT,
    LOGIN_GET_NAME_PLAYER,
    LOGIN_CHECK_CREATE_NEW_ACCOUNT,
    LOGIN_CHECK_CREATE_NEW_PLAYER,
    LOGIN_GET_PASSWORD_ACCOUNT,
    LOGIN_GET_PASSWORD_PLAYER,
