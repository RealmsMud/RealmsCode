...
GENERAL_SOURCE += global.cpp gods.cpp groups.cpp guilds.cpp healers.cpp healmagic.cpp hooks.cpp illusion.cpp
GENERAL_SOURCE += io.cpp import.cpp levelGain.cpp location.cpp log.cpp logic.cpp login.cpp lottery.cpp magic.cpp
GENERAL_SOURCE += magic1.cpp mccp.cpp md5.cpp memory.cpp misc.cpp money.cpp msdp.cpp monsters.cpp monType.cpp mordorMain.cpp
GENERAL_SOURCE += movement.cpp necromancy.cpp objIncrease.cpp object.cpp objects.cpp objectAttr.cpp oldQuest.cpp
